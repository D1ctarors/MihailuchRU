...
let html = "./src/img/projects/stack/html.svg",
...
const dataPortfolioCardItem = [
  // 15 - SECRET
  {
    ...
    links: {
      ...
      figmaLink:
        "https://www.figma.com/file/1gZDycVzH1POQ2JYklYfcU/%D0%9D%D0%B0%D1%80%D0%B0%D1%89%D0%B8%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5-%D1%80%D0%B5%D1%81%D0%BD%D0%B8%D1%86?type=design&node-id=1%3A2&mode=design&t=bvTnAq6poTtihFXM-1",
  ...
  // 14 - Mihailuch 3.0
  {
    ...
    links: {
      ...
      figmaLink:
        "https://www.figma.com/file/HfzNFrzTgcaiKnyvIsHUVm/Mihailuch-.3?type=design&node-id=0%3A1&mode=design&t=ulqUCjSrqWevX65f-1",
  ...
  // 13 - Парсер lordfilm
  {
    ...
    description:
      "Парсер фильмов с сайта lordfilm созданный на python. В своё время послужил инструментом для случайной ddos-атаки). Не работает.",
  ...
  // 11 - WebCinema
  {
    ...
    description:
      "Была задумка создать онлайн-кинотеатр без рекламы, подписок и прочей фигни. Создан макет. Основа - Django. Настроена регистрация и авторизация пользователей. Подключена и заполнена БД. Реализован фильтр и поиск фильмов по сайту.",
  ...
  // 10 - Mihailuch 2.0
  {
    ...
    links: {
      ...
      figmaLink:
        "https://www.figma.com/file/EWtj42jfac97Hsb9HMaowf/Mihailuch-.2?type=design&node-id=0%3A1&mode=design&t=tZ2ZWAwR7nhOiDob-1",
  ...
  // 09 - Атриум
  {
    ...
    links: {
      ...
      figmaLink:
        "https://www.figma.com/file/kf6Gg2oR6kGuzx1PrsaEqT/%D0%90%D1%82%D1%80%D0%B8%D1%83%D0%BC-(%D0%BA%D0%BE%D0%BC)?type=design&node-id=0%3A1&mode=design&t=4i1uWoPGlJ41E6bY-1",
      globalLink: "http://atrium.edavpolzu.ru/",
    },
    stack: [html, css, sass, js, figma], // html, css, sass, js, python, figma, bootstrap, django, sqlite3, photoshop
    description:
      'Работа в команде, спасибо <span><a href="https://github.com/genius192x" target="_blank">Genius192x</a></span>. <br>Опыт коммерческой разработки. Опыт работы в команде. Вставка элементов через js. Работа с масками. Работа с PopUp. Вставка Lottie-анимации. Использование слайдеров. Адаптивная вёрстка по макету.',
  ...
  // 08 - Аквазонд
  {
    ...
    links: {
      githubLink: "",
      figmaLink:
        "https://www.figma.com/file/cXboPdMeazAYgeVuxB3ORm/Aquazond-(%D0%A1%D0%B8%D1%81%D1%82%D0%B5%D0%BC%D0%B0)?type=design&node-id=0%3A1&mode=design&t=UCN80KrnHV5Hbwc8-1",
      globalLink: "",
    },
    stack: [html, css, sass, js, figma], // html, css, sass, js, python, figma, bootstrap, django, sqlite3, photoshop
    description:
      'Работа в команде, спасибо <span><a href="https://github.com/genius192x" target="_blank">Genius192x</a></span>. <br> Разработка концепта внутренней системы и редизайна сайта. Вёрстка макета внутренней системы',
  ...
  // 07 - Discounts
  {
    ...
    links: {
      ...
      figmaLink:
        "https://www.figma.com/file/fs3yrqJKKRtM6tx7DsCVcH/Discounts?type=design&node-id=188%3A70&mode=design&t=TssQTiCd43ai2jrY-1",
  ...
  // 05 - Aperture
  {
    ...
    links: {
      ...
      figmaLink:
        "https://www.figma.com/file/blVze6idYnyRJkLG88L5eA/Aperture?type=design&node-id=0-1&mode=design",
  ...
  // 04 - MTBiking
  {
    ...
    links: {
      ...
      figmaLink:
        "https://www.figma.com/file/EwWfytg2JJYZelhJ6JYPZ4/Landing-Page-(Community)?type=design&node-id=0%3A1&mode=design&t=8pjGCDh4GlggL1xQ-1",
            ...
            <div class="col-lg-4">
              ...
              <ul class="projects-content__project-stack d-flex align-items-center flex-wrap gap-3">
                ${stackItems
                  .map(
                    (stackItem) =>
                      `<li class="stack-item"><img src="${stackItem}" alt="${stackItem}"></li>`
                  )
                  .join("")}
              </ul>
            </div>
